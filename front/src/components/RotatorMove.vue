  ...
  <v-container fluid>
    <v-row justify="center" align="center" class="text-center">
      <v-col cols="4" class="text-center">
        <v-btn @click="buttonClick(1)" class="custom-button"><MdiSvg size="50">{{ mdiArrowUpThin }}</MdiSvg></v-btn>
      </v-col>
    </v-row>
    <br>
    <v-row justify="center" align="center">
      <v-col cols="4" class="text-center">
        <v-btn @click="buttonClick(2)" class="custom-button"><MdiSvg size="50">{{ mdiArrowLeftThin }}</MdiSvg></v-btn>
        <v-btn @click="buttonClick(3)" class="custom-button"><MdiSvg size="50">{{ mdiArrowRightThin }}</MdiSvg></v-btn>
      </v-col>
    </v-row>
    <v-row justify="center" align="center">
      <v-col cols="4" class="text-center">
        <v-btn @click="buttonClick(4)" class="custom-button"><MdiSvg size="50">{{ mdiArrowDownThin }}</MdiSvg></v-btn>
      </v-col>
    </v-row>
    <br>
